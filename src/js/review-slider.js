...
var slider = (function (config) {
  ...
  const ClassName = {
    INDICATOR_ACTIVE: 'slider-2__indicator_active',
    ITEM: 'slider-2__item',
    ITEM_LEFT: 'slider-2__item_left',
    ITEM_RIGHT: 'slider-2__item_right',
    ITEM_PREV: 'slider-2__item_prev',
    ITEM_NEXT: 'slider-2__item_next',
    ITEM_ACTIVE: 'slider-2__item_active'
  }
  ...
  var
    ...
    _actionClick = function (e) {
      ...
      if (!(e.target.hasAttribute('data-slide-to') || e.target.classList.contains('slider-2__control'))) {
        return; 
      }
      if (e.target.hasAttribute('data-slide-to')) {
        ...
        e.preventDefault();
        _slideTo(e.target.classList.contains('slider-2__control_next') ? 'next' : 'prev');
      }
    },
